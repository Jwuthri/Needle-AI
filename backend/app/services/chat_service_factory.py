...
class ChatServiceFactory:
    ...
    Note: Agno has been replaced with LlamaIndex workflow.
    Chat services now use a simpler custom implementation.
    """
    ...
    async def create_chat_service(
        ...
        Args:
            ...
            service_type: Preferred service type (auto, custom)
