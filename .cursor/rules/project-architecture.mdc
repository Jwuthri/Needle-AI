...
- `needleai/backend/` - FastAPI backend application
- `needleai/frontend/` - Next.js frontend application
...
### Key Patterns
1. **CQRS Architecture**: Commands and Queries are separated with dedicated buses in [app/core/cqrs/](mdc:needleai/backend/app/core/cqrs/)
...
5. **Environment Configuration**: Settings managed via Pydantic settings in [app/core/config/](mdc:needleai/backend/app/core/config/)
