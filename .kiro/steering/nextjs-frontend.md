...
## Next.js App Router
- Use Next.js 14+ App Router structure in [src/app/](mdc:needleai/frontend/src/app/)
- File-based routing with `page.tsx`, `layout.tsx`, `loading.tsx`, `error.tsx`
- Server and Client Components appropriately
- Use `"use client"` directive only when necessary

## TypeScript Standards
- **Strict TypeScript**: Enable strict mode in [tsconfig.json](mdc:needleai/frontend/tsconfig.json)
- **Type Definitions**: Define interfaces in [src/types/](mdc:needleai/frontend/src/types/)
...
## Component Structure
- **Organization**: Group components by feature in [src/components/](mdc:needleai/frontend/src/components/)
...
- **Global State**: Use Context API with providers in [src/components/providers/](mdc:needleai/frontend/src/components/providers/)
- **Server State**: Use custom hooks for API data fetching
- **Form State**: Use controlled components with validation

## Custom Hooks
- **Location**: Place custom hooks in [src/hooks/](mdc:needleai/frontend/src/hooks/)
...
- **Configuration**: Use [tailwind.config.js](mdc:needleai/frontend/tailwind.config.js) for customization
- **Utility-First**: Prefer Tailwind utility classes
- **Custom Styles**: Use [src/app/globals.css](mdc:needleai/frontend/src/app/globals.css) for global styles
...
## API Integration
- **Client**: Use API client in [src/lib/api.ts](mdc:needleai/frontend/src/lib/api.ts)
...
- **Provider**: Wrap app with `ClerkProvider` in [src/app/layout.tsx](mdc:needleai/frontend/src/app/layout.tsx)
- **Components**: Use Clerk components for auth UI
- **Hooks**: Use `useUser()`, `useAuth()` for authentication state
- **Middleware**: Configure [middleware.ts](mdc:needleai/frontend/middleware.ts) for route protection
