...
- **Backend**: [needleai/backend/Dockerfile](mdc:needleai/backend/Dockerfile)
- **Frontend**: [needleai/frontend/Dockerfile](mdc:needleai/frontend/Dockerfile)
- **Docker Compose**: [docker-compose.yml](mdc:needleai/docker-compose.yml) for orchestration
...
- **Development**: Use [docker/docker-compose.dev.yml](mdc:needleai/backend/docker/docker-compose.dev.yml)
- **Tracing**: Use [docker/docker-compose.tracing.yml](mdc:needleai/backend/docker/docker-compose.tracing.yml) for observability
- **Production**: Base compose file with production overrides

## Environment Configuration

### Environment Files
- **Template**: [config_template.env](mdc:needleai/backend/config_template.env) as reference
...
### Management Scripts
Use scripts in [scripts/](mdc:needleai/backend/scripts/) for deployment management:
...
echo "🚀 Starting NeedleAi services..."
...
### Distributed Tracing
Use OpenTelemetry configuration in [docker/otel-collector-config.yml](mdc:needleai/backend/docker/otel-collector-config.yml):
